    ...
    steps:
      ...
      - name: Generate summary report
        ...
        run: |
          ...
          echo '```' >> $GITHUB_STEP_SUMMARY
          python analyze.py --report summary >> $GITHUB_STEP_SUMMARY || echo "Could not generate summary"
          echo '```' >> $GITHUB_STEP_SUMMARY
          echo "" >> $GITHUB_STEP_SUMMARY
          ...
          echo '```' >> $GITHUB_STEP_SUMMARY
          python analyze.py --report channels >> $GITHUB_STEP_SUMMARY || echo "Could not list channels"
          echo '```' >> $GITHUB_STEP_SUMMARY
          echo "" >> $GITHUB_STEP_SUMMARY
          ...
          echo '```' >> $GITHUB_STEP_SUMMARY
          python analyze.py --report fetch-history >> $GITHUB_STEP_SUMMARY || echo "Could not get fetch history"
          echo '```' >> $GITHUB_STEP_SUMMARY
